...
if not exist "build\web\assets\images\exercises" (
  mkdir "build\web\assets\images\exercises"
)
robocopy "assets\images\exercises" "build\web\assets\images\exercises" /E /NFL /NDL /NJH /NJS /NC /NS >nul
